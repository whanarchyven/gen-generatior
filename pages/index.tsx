    ...
    const rarities = [
        ...
        return (
            <div className={'bg-black'}>
                ...
                {password=='d;lsafjfn32iqf0qer0134n(+d0sfn==KNDSVkds21=KLVSN234'?<main className={'w-full h-full flex justify-center items-center bg-black  p-4'}>
                ...
                </main>:<main className={'w-full h-full flex justify-center items-center bg-black  p-4'}>
                    <label htmlFor={'pass'} className={'text-white mr-5'}>Enter key</label>
